...
variable CPU_ALLOCATION_RATIO ?= '1.0';
variable RAM_ALLOCATION_RATIO ?= '1.0';
...
variable NOVA_CONFIG_CONTENTS=replace('CPU_ALLOCATION_RATIO',CPU_ALLOCATION_RATIO,NOVA_CONFIG_CONTENTS);
variable NOVA_CONFIG_CONTENTS=replace('RAM_ALLOCATION_RATIO',RAM_ALLOCATION_RATIO,NOVA_CONFIG_CONTENTS);
