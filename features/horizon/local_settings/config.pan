unique template features/horizon/local_settings/config;
...
include 'features/horizon/local_settings/schema';
...
'config' = file_contents('features/horizon/local_settings/django-horizon.tt');
...
'contents/keystone/host' = OS_KEYSTONE_PUBLIC_HOST;
...
'contents/ssl' = if ( OS_HORIZON_PROTOCOL == 'https' ) true else false;
