...
'contents/glance_store/rbd_store_pool' = OPENSTACK_CEPH_GLANCE_POOL;
'contents/glance_store/rbd_store_user' = OPENSTACK_CEPH_GLANCE_USER;
'contents/glance_store/rbd_store_ceph_conf' = OPENSTACK_CEPH_GLANCE_CEPH_CONF;
