...
'module' = 'tiny';
# [ml2] section
'contents/ml2/type_drivers' = OPENSTACK_NEUTRON_DRIVERS;
'contents/ml2/mechanism_drivers' = openstack_list_to_string(OPENSTACK_NEUTRON_MECHANISM_DRIVERS);
'contents/ml2/tenant_network_types' = OPENSTACK_NEUTRON_TENANT;
