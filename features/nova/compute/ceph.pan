...
'contents/libvirt/images_rbd_pool' = OPENSTACK_CEPH_NOVA_POOL;
'contents/libvirt/images_rbd_ceph_conf' = OPENSTACK_CEPH_NOVA_CEPH_CONF;
'contents/libvirt/disk_cachemodes'='"network=writeback"';
'contents/libvirt/rbd_user' = OPENSTACK_CEPH_NOVA_USER;
'contents/libvirt/rbd_secret_uuid' = OPENSTACK_CEPH_LIBVIRT_SECRET;
