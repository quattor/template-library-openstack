...
'contents/rbd/rbd_pool' = OPENSTACK_CEPH_CINDER_POOL;
'contents/rbd/rbd_ceph_conf' = OPENSTACK_CEPH_CINDER_CEPH_CONF;
...
'contents/rbd/rbd_user' = OPENSTACK_CEPH_CINDER_USER;
'contents/rbd/rbd_secret_uuid' = OPENSTACK_CEPH_LIBVIRT_SECRET;

'contents/rbd/backup_driver' = 'cinder.backup.drivers.ceph';
'contents/rbd/backup_ceph_conf' = OPENSTACK_CEPH_CINDER_BACKUP_CEPH_CONF;
'contents/rbd/backup_ceph_user' = OPENSTACK_CEPH_CINDER_BACKUP_USER;
'contents/rbd/backup_ceph_chunk_size' = '134217728';
'contents/rbd/backup_ceph_pool' = OPENSTACK_CEPH_CINDER_BACKUP_POOL;
